...
export class Contact extends Component {
   ...
   submit=e=>{
    if(this.valid()){
      ...
      axios.post('http://localhost:5000/contactus',{name:this.state.name,email:this.state.email,message:this.state.message})
            .then(response=>{
            ...
            <div className="container">
             <div className="row">
               <div className="col-12 col-sm-5 mt-5 mb-5 offset-1"><br/><br/><br/><br/><img src="../assets/images/message6.png"/>
                    ...
                    <Modal isOpen={this.state.show} centered size="lg" contentClassName="custom-modal-style">
                      ...
                      <ModalBody>
                        ...
                        {/* <iframe src="https://docs.google.com/forms/d/e/1FAIpQLScor1dLRawEAJt4ahgM6f1gI_emHr8DP8Hn-FmEvLJfbBTE-w/viewform?embedded=true" width="640" height="200" frameborder="0" marginheight="0" marginwidth="0">Loading…</iframe> */}
                      </ModalBody>
                      <ModalFooter>
               ...
               <div className="col-12 col-sm-5 "><br/><br/><br/><br/><br/><br/>
                   ...
                   <a href="https://mail.google.com/mail/u/0/?tab=rm#inbox?compose=CllgCJfrsgQDHQkLnnkCKGsXBbvRqjTjdMXkFBsXLtsFhfKlxjNvtvlFKMPlPnqwMgppBVkRBKL"> <i className="fa fa-envelope fa-2x m-2" style={{backgroundColor:"#3b5998",padding:"10px",color:"white"}} id="contact"></i></a><label>fastforwardindia.org@gmail.com</label>
